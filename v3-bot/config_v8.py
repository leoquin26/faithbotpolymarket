...
BANKROLL_BALANCE = float(os.getenv("BANKROLL_BALANCE", "115"))
...
MIN_DISTANCE_PCT = float(os.getenv("MIN_DISTANCE_PCT", "0.0015"))
MIN_WIN_PROB = float(os.getenv("MIN_WIN_PROB", "0.68"))
MIN_CROSS_AGE = int(os.getenv("MIN_CROSS_AGE", "45"))
WARMUP_SEC = int(os.getenv("WARMUP_SEC", "90"))
