...
VERSION = "1.30.0"  # bump on EVERY change + add a CHANGELOG.md entry + git tag cleanbot-vX.Y.Z
...
class Cfg:
    ...
    min_t: int = int(os.getenv("CLEAN_MIN_T", "720"))               # v1.30: 600→720 — only enter with ≥12min left (window age ≤180s). Live data (297 fills): age 0-180s wins +2/+3 over break-even; age 180-320s runs −6/−10 BELOW (buying a stale move = buying exhaustion; the 70c ETH UP loss entered at age 280s)
